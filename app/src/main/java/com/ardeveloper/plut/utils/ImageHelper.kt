...
object ImageHelper {
        ...
        if (mBitmap != null) {
         ...
         //   val extr = Environment.getExternalStorageDirectory().toString()
            ...
            try {
                ...
                fos!!.close()
                val path =
                    MediaStore.Images.Media.insertImage(context.getContentResolver(), mBitmap, "plut", "plut")
    ...
    fun downloadScreenshot(context: Context, nestedScrollView:NestedScrollView) {
        ...
        if (mBitmap != null) {
            ...
            val direct = File("${Environment.getExternalStorageDirectory()}/yourstore" )
            if (!direct.exists()) {
                val mkdir = direct.mkdir()
            }
            val extr = Environment.getExternalStorageDirectory().toString()
            val fileName = "yourstore/img_" + System.currentTimeMillis().toString() + ".jpg"
            ...
            try {
                ...
                fos!!.close()
                val path =
                    MediaStore.Images.Media.insertImage(context.getContentResolver(), mBitmap, "yourstore", "yourstore")
    ...
    private fun generateNotif(context: Context, path: String, bitmap: Bitmap) {
        ...
        builder.setAutoCancel(true)
            ...
            .setContentText("Salary slips downloaded successfully")
        ...
        Toast.makeText(context, "Salary slips downloaded successfully", Toast.LENGTH_SHORT).show()
    }
}
